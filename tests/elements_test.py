...
class TestElements:
    ...
    class TestLinksPage:
        ...
        def test_bed_request_link(self, driver):
            links_page = LinksPage(driver, 'https://demoqa.com/links')
            links_page.open()
    ...
    class TestUploadAndDownloadPage:
        ...
        def test_download_file(self, driver):
            upload_download_page = UploadAndDownloadPage(driver, 'https://demoqa.com/upload-download')
            upload_download_page.open()
            check_download = upload_download_page.download_file()
            assert check_download is True, "the file has not been downloaded"
    ...
    class TestDynamicPropertiesPage:
        ...
        def test_change_color_of_button(self, driver):
            dynamic_properties_page = DynamicPropertiesPage(driver, 'https://demoqa.com/dynamic-properties')
            dynamic_properties_page.open()
            color_before, color_after = dynamic_properties_page.check_changer_of_color()
            assert color_after != color_before, "the color of button has not been changed"
